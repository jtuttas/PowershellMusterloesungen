...
function Find-Company
{
    ...
    Begin
    {
        ...
        $r=Invoke-RestMethod -Method Get -Uri ($uri+"admin/betriebe/"+$name) -Headers $headers  
        return $r;
    }
    Process
    {
...
function Set-Company
{
    ...
    Begin
    {
        ...
        $headers["content-Type"]="application/json;charset=iso-8859-1"
        $headers["auth_token"]=$global:auth_token;
        $r=Invoke-RestMethod -Method Post -Uri ($uri+"admin/betriebe/id/"+$id) -Headers $headers -Body (ConvertTo-Json $betrieb)
        return $r;
    }
    Process
    {
...
function Delete-Company
{
    ...
    Process
    {
        foreach ($i in $id) {
            ...
            $headers["content-Type"]="application/json;charset=iso-8859-1"
            $headers["auth_token"]=$global:auth_token;
            $r=Invoke-RestMethod -Method Delete -Uri ($uri+"admin/betriebe/"+$i) -Headers $headers 
            return $r;
        }
    }
    End
...
function Get-Company
{
    ...
    Process
    {
        foreach ($i in $id) {
            ...
            $headers["content-Type"]="application/json;charset=iso-8859-1"
            $headers["auth_token"]=$global:auth_token;
            $r=Invoke-RestMethod -Method Get -Uri ($uri+"admin/betriebe/id/"+$i) -Headers $headers 
            return $r;
        }
    }
    End
...
function New-Company
{
    ...
    Begin
    {
        ...
        $headers["content-Type"]="application/json;charset=iso-8859-1"
        $headers["auth_token"]=$global:auth_token;
        $r=Invoke-RestMethod -Method Post -Uri ($uri+"admin/betriebe/"+$id) -Headers $headers -Body (ConvertTo-Json $betrieb)
        return $r;
    }
    Process
    {
